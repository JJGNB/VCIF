...
def create_lmdb_for_lmm():
    """Create lmdb files for DIV2K dataset.
        ...
        """
    # ir images
    folder_path = 'datasets/train/LMM/ir'
    lmdb_path = 'datasets/train/LMM/ir_lmdb.lmdb'
    img_path_list, keys = prepare_keys_lmm(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # vi images
    folder_path = 'datasets/train/LMM/vi'
    lmdb_path = 'datasets/train/LMM/vi_lmdb.lmdb'
    img_path_list, keys = prepare_keys_lmm(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # ve images
    folder_path = 'datasets/train/LMM/vi_en'
    lmdb_path = 'datasets/train/LMM/ve_lmdb.lmdb'
    img_path_list, keys = prepare_keys_lmm(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
def prepare_keys_lmm(folder_path):
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--dataset',
        type=str,
        help=("Options: 'DIV2K', 'REDS', 'Vimeo90K','LMM' You may need to modify the corresponding configurations in codes."))
